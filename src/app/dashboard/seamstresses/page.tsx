			...
			<div className='py-4'>
				<div className='flex flex-wrap gap-6'>
					{seamstresses.map((seamstress: User) => (
						<div key={seamstress.id} className='bg-white rounded-2xl p-8 border hover:border-gray-300 transition-colors w-[300px]'>
							<div className='flex flex-col items-center text-center mb-6'>
								...
								<Link href={`/dashboard/seamstresses/${seamstress.id}`} className='text-xl font-semibold mb-1 hover:underline'>
